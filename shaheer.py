...
\033[1;91m--> GITHUB :- https://github.com/shaheerAk47/Mrvenom
...
def menu():
	...
	print "	   ID\033[1;91m:\033[1;93m"+id+"\x1b[1;93m              "
        ...
        time.sleep(0.05)
	print "1 .\x1b[1;93m\033[1;94mStart Cloning   "
        time.sleep(0.05)
...
def tokenz():
	os.system('clear')
	print logo
	toket = raw_input("\033[1;93mToken\033[1;91m : 3NTER ACCES T0k3N  :- ")
	try:
